 ...
 *  @apiSignature: ContiguousArray$ mutating func append(_ newElement: Element)
 *  @description: Test swift api ContiguousArray$ mutating func append(_ newElement: Element)
