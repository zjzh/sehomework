...
class Calendar_compare_Date_Date_Calendar_Component{
     ...
     * Date$date2-DateFormatter.date(from string: String) -> Date? & String$from="2019-11-11T11:11:11-08:00" & https://developer.apple.com/documentation/foundation/dateformatter/1409994-date
     */
     ...
     * date2 Date$date2
     * output: 1
     * ret0 ret0=ComparisonResult.orderedDescending
     * Date$date1-DateFormatter.date(from string: String) -> Date? & String$from="2013-6-1T13:24:16-08:00" & https://developer.apple.com/documentation/foundation/dateformatter/1409994-date
     * Date$date2-DateFormatter.date(from string: String) -> Date? & String$from="2012-11-11T11:11:11-08:00" & https://developer.apple.com/documentation/foundation/dateformatter/1409994-date
     */
    static func compare1(){
        ...
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ssZZZZZ"
        let date1=dateFormatter.date(from:"2013-6-1T13:24:16-08:00")
        let date2=dateFormatter.date(from:"2012-11-11T11:11:11-08:00")
        let class0 = Calendar(identifier: Calendar.Identifier.chinese)
        let ret0=class0.compare(date1!,to:date2!,toGranularity:Calendar.Component.second);
...
Calendar_compare_Date_Date_Calendar_Component.compare1()
