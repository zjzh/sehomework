...
public class FileInputStream_read_byte_int_int {
	 ...
	 * len len= 1
     * output: 1
	 * FileInputStream$class0-FileInputStream$FileInputStream(String path) & path = "D://test.txt" & https://developer.android.google.cn/reference/java/io/FileInputStream.html#FileInputStream(java.lang.String)
     * byte[]$b-byte[]$byte[m] & int m = 4 & https://stackoverflow.com/questions/858980/file-to-byte-in-java
	 */
