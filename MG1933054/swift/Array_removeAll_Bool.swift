...
class Array_removeAll_Bool {
   ...
   *output : 0
   *Array$class0-init<S>(_ elements: S) where S : Sequence, Self.Element == S.Element & String$S & https://developer.apple.com/documentation/swift/arrayslice/2884787-removeall
   */
