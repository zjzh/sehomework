...
public class PrintStream_println_int{
         ...
         * x  x=1
         * output: 0
         *PrintStream$class0-File$File(String pathname);PrintStream$PrintStream(File file) & String$pathname="result.txt" & https://github.com/a1027739669/IndividualProject2/blob/cf07a91e28b92ed3942db92f43d009be455b3357/src/main/java/zyx/func/Main.java
         *PrintStream$class0-PrintStream$PrintStream(String fileName) & String$fileName="result.txt" & https://github.com/rajesh-rak/DLPScanner/blob/a93ae30a4e480f1ace5cd64302d62a36083c48ee/ScanOut/RUN_2017_12_10_225821/Test29/RandoopTest0.java
         */
