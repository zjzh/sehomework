 ...
 *  @className: NSString_init_format_CVaListPointer$NSString__TextOutputStream_write_String
 ...
 */
import Foundation
class NSString_init_format_CVaListPointer$NSString__TextOutputStream_write_String{
    /**
     *input : 3
...
NSString_init_format_CVaListPointer$NSString__TextOutputStream_write_String.init_write0()