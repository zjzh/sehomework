 ...
 */
 ...
 class Strinig_prefix_String$Index__String_lastIndex_Character{
      ...
      *String.Index$through-String$index(_ i:String.Index,offsetBy n:String.IndexDistance)& _=String$startIndex;offsetBy=11 &https://stackovewflow.com/questions/32967445/how-to-check-what-a-string-starts-with-prefix-or-ends-with-suffix-in-swift.com
      */
     static func prefix_lastIndex0(){
         print(">>>>>>>>>>>>>>>>>")
         let class0="Hello,World"
         let through=class0.index(class0.startIndex,offsetBy:11)
         let ret0=class0.p/**类名_方法名(_形参类型)*
 * @author:MG1933073 熊俊
 * @className:String_prefix_String$Index__String_lastIndex_Character
...
Strinig_prefix_String$Index__String_lastIndex_Character.prefix_lastIndex1();refix(through:through)
         let class1=String(ret0)
         let ret1=class1.lastIndex(of:"W")
         assert(class1=="Hello,World")
         assert(class1[ret1!]=="W")
