...
class FileHandle_closeFile{
     ...
     * output: 0
     * FileHandle$class0-FileHandle(forReadingAtPath path: String)&path="C:\\Users\\Bobing\\Desktop\\test.txt"&https://developer.apple.com/documentation/foundation/filehandle
     */
