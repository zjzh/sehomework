 ...
 *  @className:Array_sort_function
 *  @apiSignature: Array$mutating func sort(by areInIncreasingOrder: (Element, Element) throws -> Bool) rethrows
 *  @description: Test swift api Array$sort(by areInIncreasingOrder: (Element, Element) throws -> Bool) 
...
Array_sort_function.sort0()
Array_sort_function.sort1()